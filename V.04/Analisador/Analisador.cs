...
namespace Analisador
{
    ...
    {
        // ========================================================================
        public int Decompor( string         p_Codigo_Fonte = "", 
                             frm_Aplicativo p_Formulario   = null )
        {
            // Variáveis:
                int Quant_Funcoes = 0;
                int indice = -1;
                ...
                int CF_Tam = 0;
                List<int> Lst_Funcoes_Indices = new List<int>();
                int FI_Quant = 0;
                int FI_Cont = 0;
                string funcao = "";
                string F_Nome = "";
            ...
            // Programa:
                ...
                // Exibe cada função em uma Aba, na Aba Funções
                    ...
                    for (FI_Cont = 0; FI_Cont < FI_Quant; FI_Cont++ )
                    {
                        ...
                        F_Ini = Lst_Funcoes_Indices[FI_Cont];
                        F_Tam = ( (FI_Cont < (FI_Quant-1)) ? Lst_Funcoes_Indices[FI_Cont+1] : CF_Tam ) - F_Ini;
